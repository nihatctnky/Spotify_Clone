export default class UI {
    // Html çagırdıgımız arayüz elementleri
    constructor() {
    ...
    renderCards(songs) {
        ...
        // apiden gelen herbir nesne için ekrana kart bas
        songs.forEach((song) => {

            const div = document.createElement("div");
            div.className = "card";

            // Kart elemanına mmüzik bilgilerini dataset olarak ekle
                ...
                <div class="loader">
                    <div class="audio-player">
                        ...
                        <div class="player-controls">
                            ...
                            <div class="buttons">
                                <button class="play-btn"><svg viewBox="0 0 16 16" class="bi bi-play-fill"
                                ...
                                <button class="pause-btn"><svg viewBox="0 0 16 16" class="bi bi-pause-fill"
                                        fill="currentColor" height="16" width="16" xmlns="http://www.w3.org/2000/svg"
                                        style="color: white">
                                        <path fill="white"
    ...
    // Animasyon varsa ekle yoksa çıkar
